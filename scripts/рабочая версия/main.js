       ...
       function AnimateCircles(){
            ...
            "stroke-opacity": 0.5
              ...
              progress: function (animate, progress) {
                  $('#text1').text(Math.round(progress * 95));
              }});
        ...
        $('#circle2').animate({
            ...
            duration: 2000,
            progress: function (animate, progress) {
                $('#text2').text(Math.round(progress * 95));
            }});
        $('#circle3').animate({
            fill: "#223fa3",
            stroke: "#000",
            ...
            duration: 2000,
            progress: function (animate, progress) {
                $('#text3').text(Math.round(progress * 80));
            }
        });
         ...
         $('#circle4').animate({
            ...
            duration: 2000,
            progress: function (animate, progress) {
                $('#text4').text(Math.round(progress * 75));
            }
        });
...
function toggleOverFlowHiddenMobileMenu(){var checked=$('#mobileNavToggle').is(":checked")
if(checked==0){$('.index.home > a').removeClass('fade');$('body').addClass('overflow-hidden');}else{$('.index.home > a').addClass('fade');$('body').removeClass('overflow-hidden');}}
$(document).ready(function(){$("#menuBlockSelected").hover(function(){$(".menuHr").css("display","none");});$("#menuBlockSelected").mouseleave(function(){$(".menuHr").css("display","");});$(".scrollIndicator").click(function(){$('html, body').animate({scrollTop:$(".page-content").offset().top},1600);});$("#mobileNavBars").click(function(){toggleOverFlowHiddenMobileMenu();});$(".icon-10").hover(function(){$(".icon-15,.icon-17,.icon-26").css("fill","#585656");},function(){$(".icon-15,.icon-17,.icon-26").css("fill","#fff");});$(".icon-15").hover(function(){$(".icon-10,.icon-17,.icon-26").css("fill","#585656");},function(){$(".icon-10,.icon-17,.icon-26").css("fill","#fff");});$(".icon-17").hover(function(){$(".icon-10,.icon-15,.icon-26").css("fill","#585656");},function(){$(".icon-10,.icon-15,.icon-26").css("fill","#fff");});$(".icon-26").hover(function(){$(".icon-10,.icon-15,.icon-17").css("fill","#585656");},function(){$(".icon-10,.icon-15,.icon-17").css("fill","#fff");});});

function NotificationSignUp(){var a=$("#fieldEmail").val(),b=/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/,c=b.test(a);c?$.ajax({type:"post",url:"./notificationSignUp.php",data:{email:a},success:function(a){$("#commentform").hide(),$("#fieldEmail").val(""),$("#subForm").slideToggle(),$(".fine-print").css("color","white"),$(".fine-print").text(a)},error:function(a,b,c){$(".fine-print").css("color","red"),$(".fine-print").text("Your email was not valid. Try again.")}}):($(".fine-print").css("color","red"),$(".fine-print").text("Your email was not valid. Try again."))}
