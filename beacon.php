    ...
    <div class="project-details" style="box-sizing:border-box;">
        <div class="project-details-primary">
            ...
            <div class="project-details-intro">
                <p>По сути, beacon - это одностраничная канва, которую с легкостью можно переделать под нужды заказчика. Создана для демострации адаптивного дизайна и эффектных анимаций. </p>
            </div>
