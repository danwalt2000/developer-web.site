            ...
            <div class="page-content">
                <div class="layout">
                    ...
                    <div class="briefBackgroundBlock">
                        ...
                        <div class="MyCol2">
                            <div class="paddingMy">
                                <p class="homepageDescription">Я - веб-дизайнер и разработчик широкого профиля. Специализируюсь на верстке и настройке серверной части веб-приложений и сайтов. Я искренне считаю, что высококлассный веб-дизайн должен быть чистым и простым, и, в то же время, привлекающим внимание пользователя.</p>
                            </div>
                        </div>
                        <div class="MyColSide">
                            <div class="My-block-image"></div>
                    ...
                    <div class="myServices">
                        ...
                        <div class="wrap cf text-c">
                            <div class="splitColumnsMy">
                                ...
                                <h2>Разработка</h2>
                                <p class="servicesParagraph">Прежде всего - я программист, дизайн - это мое хобби. Я специализируюсь и на front-end, и на back-end разработке, пишу чистый и понятный код, используя популярные библиотеки и фреймвёрки. В работе руководствуюсь принципом Стивена Кинга: "Вторая версия написанного - это первая версия, минус 15%".</p>
                            </div>
                            <div class="splitColumnsMy">
