...
<html lang="ru">
    ...
    <script src="scripts/swipebox.js"></script>
    <script src="Scripts/home.js" type="text/javascript"></script>
    <script src="Scripts/main.js" type="text/javascript"></script>
    <script src="Scripts/notificationsignup.js" type="text/javascript"></script>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
       ...
       <div id="siteWrapper" class="siteWrap">
            ...
            <nav class="navGrid">
             <ul class="menuList">
                 ...
                 <a class="menuBlockLink" href="index.php">
                     <div id="menuBlockSelected" class="menuBlock menuBlockFirst" ><div class="linkSummary"><span class="counterSpan">01.</span><header class="MenuHeader">Главная</header><p>Краткое информация.</p></div><hr class="menuHr"></div>
                 </a></li>

                 <li class="a-nav-item">
                 <a class="menuBlockLink" href="about.html">
                     <div class="menuBlock" ><div class="linkSummary"><span class="counterSpan">02.</span><header class="MenuHeader">Обо мне</header><p>Немного информации обо мне.</p></div></div>
                 </a></li>
                 
                 <li class="a-nav-item">
                 <a class="menuBlockLink" href="portfolio.html">
                     <div class="menuBlock" ><div class="linkSummary"><span class="counterSpan">03.</span><header class="MenuHeader">Портфолио</header><p>Некоторые проекты, над которыми я работал.</p></div></div>
                 </a></li>
         
                 <li class="a-nav-item">
                 <a class="menuBlockLink" href="experience.html">
                     <div class="menuBlock" ><div class="linkSummary"><span class="counterSpan">04.</span><header class="MenuHeader">Опыт</header><p>Мои навыки и способности.</p></div></div>
                 </a></li>
                 
                  <li class="a-nav-item">
                 <a class="menuBlockLink" href="blog-articles.php">
                     <div class="menuBlock" ><div class="linkSummary"><span class="counterSpan">05.</span><header class="MenuHeader">Блог</header><p>Мои статьи о разработке и дизайне.</p></div></div>
                 </a></li>
            </ul> 
                
        </nav>
                
                <div class="menuFiller"><div class="paddingMy"></div></div>
            ...
            <p>
            <a href="contact.html" class='HomeHeaderButtons'>Связаться со мной</a>
        ...
        <div class="page-content">
            ...
            <div class="briefBackgroundBlock">
                <div class="MyColSide"><div class="My-block-image"></div></div>
                <div class="MyCol2">
                    <div class="paddingMy">
                <p class="homepageDescription">Я - веб-дизайнер и разработчик широкого профиля. Специализируюсь на верстке и настройке серверной части веб-приложений и сайтов. 
                  Я искренне считаю, что высококлассный веб-дизайн должен быть чистым и простым, и, в то же время, привлекающим внимание пользователя.</p>
                    </div>
                </div>
                 <div class="MyColSide"><div class="My-block-image"></div></div>
            </div>
           ...
           <div class="myServices">
               ...
               <div class="wrap cf text-c">
                ...
                <h2>Разработка</h2>
                <p class="servicesParagraph">Прежде всего - я программист, дизайн - это мое хобби. Я специализируюсь и на front-end, и на back-end разработке, пишу чистый и понятный код, используя популярные библиотеки и фреймвёрки.
                  В работе руководствуюсь принципом Стивена Кинга: "Вторая версия написанного - это первая версия, минус 15%".</p>
                </div>
                <div class="splitColumnsMy">
               ...
               <svg id="Layer_1" class="icon icon-design large-icon" xml:space="preserve" enable-background="new 0 0 100 100" viewBox="0 0 100 100" height="100px" width="100px" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1">
                ...
                Веб-дизайн - это моя страсть. Я люблю свежий, стильный и неповторимый дизайн, поэтому создал собственный алгоритм, который позволяет мне писать уникальные и привлекательные сайты.
                </p>
                </div>
                </div>
	...
	<section class="grey-area process">
          ...
          <div id="content">
                ...
                <a class="portfolio-content-block__link" title="Портфолио веб-разработчика" href="Myod-website.html">Подробнее</a>
                    ...
                    <div class="buttonBlock">
                      <div>
                        ...
                        <a href="portfolio.html" class="buttonBlockElement">Больше проектов</a>
                        </div>
                    </div>
                    </div>
           ...
           <div class="circleRow">
            ...
            <svg class="circleSvg" height="180" width="180">
                ...
                <circle id="circle1" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
        ...
        <div class=" top">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle2" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
                        style="stroke-dashoffset:430px;"
        ...
        <div class=" top">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle3" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle4" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle5" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle6" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="68"
                        style="stroke-dashoffset:430px;"
            ...
            <span class="skillSpan">SASS</span>
                ...
                </div><!-- end of circle row -->
                  
                  </div> <!-- end of circle container 1 -->
            ...
            <svg class="circleSvg" height="180" width="180">
                ...
                <circle id="circle13" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
                        ...
                        fill="#2FD6CA"
                        stroke-dashoffset="60"
                        transform="translate(35,50) rotate(-90)" />
                </g>
                <text id="text13"
                      x="47"
                      y="100"
        ...
        <div class=" top">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle14" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
        ...
        <div class=" top">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle15" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle16" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle17" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="circleSvg" height="180" width="180">
                ...
                <circle id="circle18" class="circleAnimate"
                        cx="-40"
                        cy="40"
                        r="58"
                        style="stroke-dashoffset:430px;"
            ...
            <span class="skillSpan">SQL</span>
                ...
                </div><!-- конец контейнера навыков -->
                  </div> <!-- конец внешнего контейнера навыков -->
                  <!-- конец маленького скрытого контейнера -->
                    ...
                    <div class="buttonBlock" id="moreSkillsButton">
                      <div>
                         <div style="text-align:center">
                        <a href="experience.html" class="buttonBlockElement">Посмотреть больше навыков</a>
                        </div>
                    </div>
                    </div>
                   ...
                   <div class="preFooterBlocks">
                       <div class="My-row">
                           ...
                           <div class="My-large-trio big columnPrefooterMy fade-in-selector fade-in-delay-500ms">
                            ...
                            <a class="button" href="mailto:danwalt@mail.ru">Оформить заказ</a>
                            </div>
                            </div>
                            </div>
